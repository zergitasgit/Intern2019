package com.swipe.navigationbar.activity
...
import com.swipe.navigationbar.AdminReceiver
import com.swipe.navigationbar.Ads
import com.swipe.navigationbar.R
import com.swipe.navigationbar.Utility
import com.swipe.navigationbar.`object`.Action
import com.swipe.navigationbar.adapter.ActionAdapter
import com.swipe.navigationbar.db.DBAction
import com.swipe.navigationbar.dialog.MainDialog
import com.swipe.navigationbar.service.WinMService
...
//        )
    ...
    private fun initAds() {
        Ads.initBanner(this, rl_ads, object : Ads.OnAdsListener {
            override fun onError() {
                rl_ads.visibility = View.GONE
            }

            override fun onAdLoaded() {
                rl_ads.visibility = View.VISIBLE
            }
