...
import com.os13lockscreen.ilockscreenos13.model.Image
import com.os13lockscreen.ilockscreenos13.screens.wallpaper.adapter.WallpaperAdapter
...
class Wallpaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.os13lockscreen.ilockscreenos13.R.layout.activity_set_wallpaper)
        onClick()
        initRecycleview()
    }
...
//        }
//        else{
            data.add(Image(com.os13lockscreen.ilockscreenos13.R.drawable.icon_background_lock))
            data.add(Image(com.os13lockscreen.ilockscreenos13.R.drawable.iphone1))
            data.add(Image(com.os13lockscreen.ilockscreenos13.R.drawable.iphone2))
            data.add(Image(com.os13lockscreen.ilockscreenos13.R.drawable.iphone3))
            data.add(Image(com.os13lockscreen.ilockscreenos13.R.drawable.iphone4))
            for (i in 1..15) {
                data.add(Image(com.os13lockscreen.ilockscreenos13.R.drawable.image + i))
            }
//        }
