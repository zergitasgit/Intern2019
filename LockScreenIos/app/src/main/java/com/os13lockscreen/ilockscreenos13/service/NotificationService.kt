...
//        filter.addAction(Intent.ACTION_BATTERY_CHANGED)
    ...
    private fun createLockScreen() {
        ...
        view =
            View.inflate(applicationContext, com.os13lockscreen.ilockscreenos13.R.layout.lock_layout, mView)
        ...
        linearLayout = view.findViewById(com.os13lockscreen.ilockscreenos13.R.id.ln_lock)

        rlCamera = view.findViewById(com.os13lockscreen.ilockscreenos13.R.id.rl_camera)
        rlFlash = view.findViewById(R.id.rl_flash)
        tvTime = view.findViewById(com.os13lockscreen.ilockscreenos13.R.id.tv_time)
        tvDate = view.findViewById(com.os13lockscreen.ilockscreenos13.R.id.tv_date)
...
//        }else{
        v = View.inflate(
            applicationContext,
            com.os13lockscreen.ilockscreenos13.R.layout.layout_password,
            passView
        )
//    }
...
//        val text = extras.getCharSequence("android.text").toString()
        ...
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (pack != null) {
                listNotification.add(
                    com.os13lockscreen.ilockscreenos13.model.Notification(
                        pack,
                        title,
                        text
                    )
    ...
    var listNotification: ArrayList<com.os13lockscreen.ilockscreenos13.model.Notification> = ArrayList()
